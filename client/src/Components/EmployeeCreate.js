...
// Functional component for creating a new employee
const EmployeeCreate = () => {
 ...
 // Mutation hook for creating a new employee
  ...
  // Query hook to refetch all employees after creating a new one
  const { refetch } = useQuery(GET_ALL_EMPLOYEES);
// State to manage and display success or error messages
